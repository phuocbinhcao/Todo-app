...
class Todolists extends Component {
  ...
  onChange = (todo) => {
    ...
    listTodosCopy = listTodosCopy.map((item) =>
  ...
  getTaskCurrentPage = () => {
    const startIndex =
      this.state.currentPage * LIMIT_TASK_IN_PAGE - LIMIT_TASK_IN_PAGE;
    return [
      ...this.state.listTodos.slice(
        startIndex,
        startIndex + LIMIT_TASK_IN_PAGE
      ),
    ];
  };
